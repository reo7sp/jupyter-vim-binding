define([
  ...
  exports.get_default_command_shortcuts = function get_default_command_shortcuts() {
    return {
      ...
      't,c': 'jupyter-notebook:change-cell-to-code',
      't,m': 'jupyter-notebook:change-cell-to-markdown',
      't,r': 'jupyter-notebook:change-cell-to-raw',
      't,y': 'jupyter-notebook:change-cell-to-code',
      't,u': 'jupyter-notebook:change-cell-to-markdown',
      't,i': 'jupyter-notebook:change-cell-to-raw',
